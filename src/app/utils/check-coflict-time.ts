...
const checkConflictTime = (firstStartTime: string, firstEndTime: string, secondStartTime: string, secondEndTime: string) => {
    // start time of first booking in mumber
    const startTimeOfFirstInNumber = stringToMuniteInNumber(
        firstStartTime
    );

    // end time of first booking in mumber
    const endTimeOfFirstInNumber = stringToMuniteInNumber(
        firstEndTime
    );
    // start time of each booking in mumber
    const startTimeOfSecondInNumber = stringToMuniteInNumber(
        secondStartTime
    );

    // end time of each booking in mumber
    const endTimeOfSecondInNumber = stringToMuniteInNumber(
        secondEndTime
    );
